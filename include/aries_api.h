 ...
 *
 * This only works if the FW currently loaded in the Retimer is capable of this
 * feature (compile option: FW_RLD_ON_SBR, version 1.24.x or later).
 *
 * @param[in]  device Struct containing device information
 * @return     AriesErrorType - Aries error code
 */
